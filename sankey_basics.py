...
Sankey(flows=[100, -12, -15, -27, -8, -19, -19],
       labels=['Fuel', 'Powertrain and accesories frictions', 'Heat to Coolant', 'Exhaust Gases', 'Charge Air Cooling', 'Air Drag', 'Rolling Resistance'],
       orientations=[0, 1, 1, 1, 1, 0, 0],
       pathlengths=[50, 10, 10, 10, 10, 40, 0],
       head_angle=160).finish()
plt.title("Internal Combustion Engine")
